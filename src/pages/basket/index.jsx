                              ...
                              <div className='d-flex basket_card'>
                                <div className='d-flex flex-column align-items-center'>
                                  <NavLink to={item.relation_type === 'warehouse_product' ? `/show/detail/${item.relation_id}/${item.name}` : `/yourDesign`} style={{ textDecoration: 'none' }}>
                                    <div className='basket_card_img' style={{backgroundImage: `url(${item.images[0]})`, backgroundColor: item.relation_type === 'product' ? '#ffffff' : '#E9E9E9', backgroundSize: 'cover', backgroundPosition: item.for_mobile ? 'none' : 'center', backgroundRepeat: 'no-repeat'}}></div>
                                  </NavLink>
