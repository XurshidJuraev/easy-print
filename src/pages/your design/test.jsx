...
// import shirt from '../../layouts/images/shirt.png'
...
//   //         console.log('File loaded successfully:', dataURL);
...
//   //           canvas.clear();
//   //           canvas.add(new fabric.Image(img, { scaleX: 300 / img.width, scaleY: 300 / img.height, crossOrigin: 'anonymous' }));
//   //           canvas.renderAll();
...
//             <div onClick={() => {handleClickTrueFalse(); handleImageClickHeader(4)}}  className={`shirt_drawing_header_select ${selectedHeader === 4 ? '' : ''}`}>
...
//               />
//               <div
//                 className={`shirt_drawing_header_select ${selectedHeader === 5 ? '' : ''}`}
//                 style={{ padding: '0' }}
//               >
...
//             <div onClick={() => {handleClick(); handleImageClickHeader(6)}} className={`shirt_drawing_header_select ${selectedHeader === 6 ? '' : ''}`} style={{ padding: '0' }}>
...
//               {isFrontView ? (
//                 <div id="tshirt-div">
                  // {/* <svg id="tshirt-backgroundpicture" onClick={() => handleClickFocus()} width={width} height={height} viewBox="0 0 604 562" fill="none" style={{position: 'relative'}} xmlns="http://www.w3.org/2000/svg">
...
//                   <img id="tshirt-backgroundpicture" src={shirt} alt="shirt" />
...
//                         <canvas style={{border: '1px solid black'}} ref={canvasRef} id="canvas" width={234} height={350} />
//                       </div>
//                     </Reveal>
//                   )}
//                 </div>
...
//                         <img style={{border: selectedImage === 1 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(1)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
...
//                         <img style={{border: selectedImage === 2 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(2)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
//                   </div>
...
//                         <img style={{border: selectedImage === 3 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(3)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
...
//                         <img style={{border: selectedImage === 4 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(4)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
//                   </div>
...
//                         <img style={{border: selectedImage === 5 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(5)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
...
//                         <img style={{border: selectedImage === 6 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(6)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
//                   </div>
...
//                         <img style={{border: selectedImage === 7 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(7)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
...
//                         <img style={{border: selectedImage === 8 ? '3px solid #ffffff' : '', borderRadius: '12px', width: '106px', height: '84px'}} onClick={() => handleImageClick(8)} src={URL.createObjectURL(imageFile)} alt="image_filter" />
//                       </div>
//                       <p>Оригинал</p>
//                     </div>
//                   </div>
...
const YourDesign = () => {
  ...
  return (
    <div>
      ...
      <select id="tshirt-design" onChange={handleDesignChange}>
      ...
      <select id="tshirt-color" onChange={handleColorChange}>
