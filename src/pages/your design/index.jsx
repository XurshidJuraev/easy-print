    ...
    <div>
      ...
      {isCategoryChange && (
        <>
          ...
          <div style={{ position: 'relative', marginTop: '-769.97841269841274px', left: '19.2%', boxShadow: '0 0.5rem 1rem rgba(0, 0, 0, 0.15)', width: '130px', height: '36px', transform: 'scale(1.3)' }}>
            <div>
      ...
      {isColorChange && (
        <>
          ...
          <div style={{ position: 'relative', marginTop: '-769.97841269841274px', boxShadow: '0 0.5rem 1rem rgba(0, 0, 0, 0.15)', left: '30.1%', width: '104px', height: '36px', transform: 'scale(1.3)' }}>
