    ...
    <>
      {loader ? (
        <center style={{background: '#F6F6F6'}}>
          <div className="center" style={{paddingTop: '184px', paddingBottom: '184px'}}>
              ...
              <div>
                ...
                <center style={{width: '100%', textAlign: 'left'}}>
                  <div style={{backgroundColor: 'white', padding: '16px'}}>
                    ...
                    <center>
                      {orderedProduct ? (
                        <button onClick={() => {addToBasket(dataBeck);}} className='add_basket_btn center' style={{width: localStorage.getItem('selectedLanguage') === 'ru' ? '100%' : '100%', height: '56px', marginTop: '18px', marginLeft: '0px', padding: '15px 18px', marginRight: '12px'}}>
                        ...
                        <button onClick={() => {addToBasket(dataBeck);}} className='add_basket_btn center' style={{width: localStorage.getItem('selectedLanguage') === 'ru' ? '100%' : '100%', height: '56px', marginTop: '18px', marginLeft: '0px', padding: '15px 18px', marginRight: '12px'}}>
                          <span>Продукт был добавлен в корзину.</span>
                        </button>
                      )}
                    </center>
                  </div>
