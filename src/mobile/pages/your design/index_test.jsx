    ...
    <div style={{overflow: 'hidden'}}>
      <style>
        {`
          ...
          .lower-canvas, .upper-canvas, .canvas-container {
      ...
      <div className='yourDesign_header_mobile'>
        ...
        <img onClick={() => {getImage(); getImageBack(); setModalLoader(true)}} data-bs-toggle="modal" data-bs-target="#exampleModal" src={basketImage} alt="basketImage" />
      </div>
      ...
      <div style={{position: 'relative', zIndex: 200, marginTop: '65px'}}>
        <div id="tshirt-div" style={{position: 'relative', left: '127px', transform: 'scale(1.5)', top: '69px'}}>
          {desigState === true && (
          ...
          <div className="yourDesign_bar">
            {desigState === true && (
              <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', position: 'relative', bottom: '-30px', zIndex: '100'}}>
                ...
                <img onClick={() => {setTextBar(true); addText()}} src={addTextImage} alt="addText" />
              </div>
            )}
        ...
        {textBar === true && (
          <>
            ...
            {textText === true && (
              <input value={TextParams.get("text").get(textUniqueKey)} onChange={(e) => TextParamsChanger({ type: "text", value: e.target.value, })} className='mobile_add_text_imput' style={{padding: "12px", minHeight: "73px", outline: "none", fontFamily: TextParams.get("fontFamily").get(textUniqueKey),}} type="text" />
            )}
