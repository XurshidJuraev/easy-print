  ...
  useEffect(() => {
    const validateOrder = () => {
      if (addressId === null) {
        ...
        setNullName(true);
      } else if (localStorage.getItem('user_phone_number') === null) {
        ...
        // Call saveOrder function if all checks pass
        saveOrder();
      }
    };

    validateOrder();
  }, [addressId, name, token]);
...
export default OrderMobileAccept