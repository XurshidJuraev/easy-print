        ...
        {data.length > 0 && (
          <>
            ...
            <div className='center flex-column' style={{marginTop: '50px',}}>
              ...
              <img style={{position: 'relative', top: '-180px', width: '70px', height: '166px'}} src={data[currentIndex].carousel_image[2]} alt={`carousel-image`} />
            </div>

            <p style={{marginTop: '-100px'}} className='hero_text_mobile'>{data[currentIndex].text}</p>

            <button className='hero_button' style={{margin: '0', height: '48px', marginTop: '32px', padding: '14px 0px 0px 30px'}}>
