          ...
          <ul style={{listStyle: 'none', width: '350px', padding: '0', justifyContent: 'space-between', display: 'flex', flexWrap: 'wrap'}}>
            ...
            <li style={{marginBottom: '64px', marginTop: '48px'}}>
              ...
              <ul style={{listStyle: 'none', padding: '0', width: '147px',}}>
                <li className='footer_text_mobile'>Корпоративным клиентам</li>
                <li className='footer_text_mobile'>Блогерам</li>
                <li className='footer_text_mobile'>Дизайнерам</li>
                <li className='footer_text_mobile'>Производителям</li>
              </ul>
            </li>
